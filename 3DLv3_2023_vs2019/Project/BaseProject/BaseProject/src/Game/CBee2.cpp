...
// 蜂2のインスタンス
CBee2* CBee2::spInstance = nullptr;
...
// 蜂2のアニメーションデータのテーブル
const CBee2::AnimData CBee2::ANIM_DATA[] =
{
	{ "",										true,	0.0f	},// Tポーズ
...
CBee2* CBee2::Instance()
{
	return spInstance;
}

// アニメーション切り替え
void CBee2::ChangeAnimation(EAnimType type)
{
...
// 衝突処理
void CBee2::Collision(CCollider* self, CCollider* other, const CHitInfo& hit)
{
...
// レベルを変更
void CBee2::ChangeLevel(int level)
{
...
// 被ダメージ処理
void CBee2::TakeDamage(int damage, CObjectBase* causedObj)
{
	//HPからダメージを引く
