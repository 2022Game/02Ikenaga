...
// チェストモンスター3のインスタンス
CChest3* CChest3::spInstance = nullptr;
...
// チェストモンスター3のアニメーションデータのテーブル
const CChest3::AnimData CChest3::ANIM_DATA[] =
{
	{ "",										true,	0.0f	},// Tポーズ
...
CChest3* CChest3::Instance()
{
	return spInstance;
}

// アニメーション切り替え
void CChest3::ChangeAnimation(EAnimType type)
{
...
// 衝突処理
void CChest3::Collision(CCollider* self, CCollider* other, const CHitInfo& hit)
{
...
// レベルを変更
void CChest3::ChangeLevel(int level)
{
...
// 被ダメージ処理
void CChest3::TakeDamage(int damage, CObjectBase* causedObj)
{
	//HPからダメージを引く
