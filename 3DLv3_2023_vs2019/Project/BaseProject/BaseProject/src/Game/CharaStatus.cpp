...
{
	// レベル 経験値  HP   攻撃　  防御　移動性  特殊ポイント 大きさ　 カメラの高さ
	...
	{   99,    99,   990,  990,   196,    3.0f,      70,      2.97f,    29.9f},
	{  100,   100,  1000, 1000,   200,    3.0f,      80,      3.00f,    30.0f},
};
...
{
	// レベル　経験値    HP　  攻撃　  防御　 移動性   特殊ポイント　大きさ　カメラの高さ
	{    1,     61,    3300,   343,    400,     1.0f,       0,       1.0f,    0.0f},
	{    2,     61,    3300,   343,    400,     1.0f,       0,       1.0f,    0.0f},
	{    3,     61,    3300,   343,    400,     1.0f,       0,       1.0f,    0.0f},
	{    4,     61,    3300,   343,    400,     1.0f,       0,       1.0f,    0.0f},
	{    5,     70,    4300,   403,    500,     1.5f,       0,       1.0f,    0.0f},
};

// リッチ(エネミー)のレベルごとにステータス
const CharaStatus ENEMY10_STATUS[ENEMY__LEVEL_MAX] =
{
	// レベル　経験値    HP　  攻撃　  防御　 移動性   特殊ポイント　大きさ　カメラの高さ
	{    1,     71,    2000,   403,    480,     1.0f,       0,       1.0f,    0.0f},
	{    2,     71,    2000,   403,    480,     1.0f,       0,       1.0f,    0.0f},
	{    3,     71,    2000,   403,    480,     1.0f,       0,       1.0f,    0.0f},
	{    4,     71,    2000,   403,    480,     1.0f,       0,       1.0f,    0.0f},
	{    5,     80,    4000,   463,    570,     1.5f,       0,       1.0f,    0.0f},
};

// ドラゴン(エネミー)のレベルごとにステータス
const CharaStatus ENEMY11_STATUS[ENEMY__LEVEL_MAX] =
{
	// レベル　 経験値   HP　  攻撃　 防御　 移動性   特殊ポイント　大きさ　カメラの高さ
	{    1,     100,   6500,   500,   550,     1.0f,       0,       1.0f,    0.0f},
	{    2,     100,   6500,   500,   550,     1.0f,       0,       1.0f,    0.0f},
	{    3,     100,   6500,   500,   550,     1.0f,       0,       1.0f,    0.0f},
	{    4,     100,   6500,   500,   550,     1.0f,       0,       1.0f,    0.0f},
	{    5,     200,   6500,   500,   550,     1.5f,       0,       1.0f,    0.0f},
};