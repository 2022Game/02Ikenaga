...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     11,    500,    83,    50,     1.0f,      0,      1.0f,    0.0f},
	{    2,     11,    500,    83,    50,     1.0f,      0,      1.0f,    0.0f},
	{    3,     11,    500,    83,    50,     1.0f,      0,      1.0f,    0.0f},
	{    4,     11,    500,    83,    50,     1.0f,      0,      1.0f,    0.0f},
	{    5,     15,    800,   103,   150,     1.0f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     12,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     12,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     12,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     12,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     20,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     15,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     15,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     15,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     15,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     25,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     20,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     20,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     20,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     20,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     30,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     25,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     25,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     25,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     25,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     35,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     30,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     30,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     30,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     30,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     40,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　 経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     100,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    2,     100,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    3,     100,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    4,     100,    330,    53,    90,     1.0f,      0,      1.0f,    0.0f},
	{    5,     200,    660,    43,   190,     1.5f,      0,      1.0f,    0.0f},
};