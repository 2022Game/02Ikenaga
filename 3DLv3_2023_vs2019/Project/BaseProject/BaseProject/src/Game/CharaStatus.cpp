...
{
	// レベル　経験値   HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     20,   1000,   103,    40,     1.0f,      0,      1.0f,    0.0f},
	{    2,     20,   1000,   103,    40,     1.0f,      0,      1.0f,    0.0f},
	{    3,     20,   1000,   103,    40,     1.0f,      0,      1.0f,    0.0f},
	{    4,     20,   1000,   103,    40,     1.0f,      0,      1.0f,    0.0f},
	{    5,     30,   1300,   153,   100,     1.5f,      0,      1.0f,    0.0f},
};
...
{
	// レベル　経験値    HP　  攻撃　 防御　 移動性   特殊攻撃　大きさ　カメラの高さ
	{    1,     22,    1400,   203,   150,     1.0f,      0,      1.0f,    0.0f},
	{    2,     22,    1400,   203,   150,     1.0f,      0,      1.0f,    0.0f},
	{    3,     22,    1400,   203,   150,     1.0f,      0,      1.0f,    0.0f},
	{    4,     22,    1400,   203,   150,     1.0f,      0,      1.0f,    0.0f},
	{    5,     30,    1800,   253,   240,     1.5f,      0,      1.0f,    0.0f},
};
