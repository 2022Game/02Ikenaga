...
//コンストラクタ
CHpGauge2::CHpGauge2()
	:CBillBoardImage("Character\\Player\\HP\\Frame.png", ETag::eExp, ETaskPriority::eExp,
...
{
	//mpFrameImage->SetPos(Position());
	mpBarImage->SetPos(Position() + CVector2(FRAME_BORDER, FRAME_BORDER));
