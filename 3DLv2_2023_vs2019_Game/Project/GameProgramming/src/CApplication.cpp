...
#define MODEL11 "res\\銃持ち敵.obj","res\\銃持ち敵.mtl"
...
void CApplication::Start()
{
	...
	new CTransparent(&mTransparent, CVector(45.7f, 5.0f, 0.0f), CVector(0.0f, 0.0f, 90.0f), CVector(26.0f, 0.5f, 7.0f));//二階の床の壁(右)
