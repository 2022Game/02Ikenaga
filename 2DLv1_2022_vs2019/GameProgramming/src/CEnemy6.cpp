...
#define TEXCOORD 73, 95, 95, 67	//テクスチャマッピング
#define TEXCOORDEX 95, 120, 95, 67
#define TEXCOORDY 123,140,95,67

int CEnemy6::sNum = 0;

void CEnemy6::Num(int num)
{
	sNum = num;
}
...
void CEnemy6::Collision()
{
	CApplication::CharacterManager()->Collision(this);
}

void CEnemy6::Collision(CCharacter* m, CCharacter* o)
{
	//めり込み調整変数を宣言する
	float x, y;
	switch (o->Tag())
...
CEnemy6::CEnemy6(float x, float y, float w, float h, CTexture* pt)
{
	Set(x, y, w, h);
